...
def render_reference_tab():
    ...
    references = {
        ...
        "Numerical Methods for Engineers – Chapra & Canale": "/assets/books/Numerical_Methods_for_Engineers_7th_Edition_Steven C Chapra_Raymond P Canale.pdf",
        #C:\Users\jagdevsinghdosanjh.RHINO\explicit-implicit-simulator\assets\books\Numerical_Methods_for_Engineers_7th_Edition_Steven C Chapra_Raymond P Canale.pdf
