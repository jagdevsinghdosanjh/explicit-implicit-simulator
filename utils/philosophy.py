...
def render_philosophy_tab():
    ...
    st.write("""
    <p>This app is a bridge—between intuition and rigor, sunlight and moonlight, breath and computation.  
    ...
    and typically involving supernatural beings or events. Real but Unknown to Visible Exitence.</p>
    """)
